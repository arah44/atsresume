...
import { Step1ProfilePreview } from './wizard/Step1ProfilePreview';
import { Step2JobSelection } from './wizard/Step2JobSelection';
import { Step3ReviewGenerate } from './wizard/Step3ReviewGenerate';
import { jobSchema, JobFormData } from './wizard/types';
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="flex flex-col max-w-4xl lg:max-w-4xl md:max-w-2xl sm:max-w-full max-h-[95vh] w-[95vw] p-0">
        <DialogHeader className="px-4 pt-4 pb-3 border-b sm:px-6 sm:pt-6 sm:pb-4">
          <DialogTitle className="flex gap-2 items-center text-xl sm:text-2xl">
